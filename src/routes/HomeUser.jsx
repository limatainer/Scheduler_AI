...
export default function HomeUser() {
  ...
  return (
    <>
      <div className="bg-indigo-50 sm:py-25 pb-10">
        <div className="flex flex-col justify-center items-center px-4 py-11 mx-auto max-w-screen-xl">
          ...
          leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto"
            ...
            <div>
              <p
                className="inline-block px-3 py-px mb-4 text-xs 
              font-semibold tracking-wider text-teal-900 uppercase 
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="relative">
            <div
              className="container relative m-auto px-6
           text-gray-500 md:px-12"
            >
              <div
                className="grid gap-6 md:mx-auto md:w-8/12
             lg:w-full lg:grid-cols-4 hover:cursor-pointer "
              >
                <div
                  className="transform transition duration-500 
               hover:scale-110 group space-y-6 border border-gray-100 
               rounded-3xl bg-white  px-8 py-12 text-center shadow-2xl
                shadow-gray-600/10 "
                >
                  <img
                  ...
                  <a
                    href="#"
                    className="relative mx-auto flex h-10
                    w-10 items-center justify-center before:absolute
                     before:inset-0 before:rounded-full before:border
                      before:border-gray-100  before:transition 
                      before:duration-300 group-hover:before:scale-125"
                  >
                    <img
